...
class Piramide(commonOperations):
    ...
    def __init__(self, altura, base, n_lados, tipo_base, altura_base):
        self._altura = altura
        self._base = base
